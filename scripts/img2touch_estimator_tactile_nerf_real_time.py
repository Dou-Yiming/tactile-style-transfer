...
class TouchEstimator:
    ...
    def estimate(self, rgb_path, depth_path, bg_path):
...
def main():
    ...
    rgb_path = "/home/ymdou/datac_ymdou/TaRF/nerfstudio/outputs/real_time_estimation_cache/rgb/0.png"
    depth_path = "/home/ymdou/datac_ymdou/TaRF/nerfstudio/outputs/real_time_estimation_cache/depth/0.npy"
    bg_path = "/home/ymdou/datac_ymdou/TaRF/nerfstudio/vision_touch_pairs/touch_bg/andrew_office_4_colmap_40_30/bg.jpg"
    
    latest_rgb_mtime = os.path.getmtime(rgb_path)
    latest_depth_mtime = os.path.getmtime(depth_path)
    print('Start listening for new rgb and depth images...')
    while True:
        # check the modified time of rgb_path, if unchanged, continue
        cur_rgb_mtime = os.path.getmtime(rgb_path)
        cur_depth_mtime = os.path.getmtime(depth_path)
        ...
        touch_estimator.estimate(rgb_path, depth_path, bg_path)
