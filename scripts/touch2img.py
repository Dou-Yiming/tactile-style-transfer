...
def main():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs/touch/eval_touch2img/touch_and_go/vision_conditional_on_touch_CMC_attn_layer5_noflip_trainable.yaml",
        help="path to config which constructs model",
    )
    parser.add_argument(
        "--ckpt",
        type=str,
        default="logs/2023-08-01T22-44-56_vision_conditional_on_touch_CMC_attn_layer5_noflip_trainable/checkpoints/last.ckpt",
