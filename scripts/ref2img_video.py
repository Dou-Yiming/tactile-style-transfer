...
def main():
    ...
    parser.add_argument(
        ...
        default="outputs/ref2img-hybrid-sample10000/"
    )
    parser.add_argument(
        "--skip_grid",
        action='store_true',
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs/touch/eval_ref2img/ref2img_cmc_video_trainable_seg_mask_hybrid_noflip.yaml",
        help="path to config which constructs model",
    )
    parser.add_argument(
        "--ckpt",
        type=str,
        default="logs/2023-02-23T09-05-34_ref2img_cmc_video_hybrid_noflip/checkpoints/last.ckpt",
