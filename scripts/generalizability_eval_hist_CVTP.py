...
if __name__ == '__main__':
    ...
    score_mean = np.concatenate([
        np.array(score_bin[0]),np.array(score_bin[1]),np.array(score_bin[2])
    ]).mean(0)
    ...
    plt.savefig('CVTP_hist.png', dpi=300, bbox_inches='tight')
