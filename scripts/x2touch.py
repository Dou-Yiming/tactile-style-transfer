...
def main():
    ...
    parser.add_argument(
        ...
        default="outputs/x2touch_img_new/"
    )
    parser.add_argument(
        "--skip_grid",
        action='store_true',
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="/home/fredyang/fredyang/stable-diffusion/configs/x2touch/test/vision.yaml",
        help="path to config which constructs model",
    )
    parser.add_argument(
        "--ckpt",
        type=str,
        default="/home/fredyang/fredyang/stable-diffusion/logs/2023-11-12T12-57-22_img2touch_imagebind_ae/checkpoints/epoch=000011.ckpt",
