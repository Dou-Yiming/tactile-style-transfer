...
def main():
    ...
    parser.add_argument(
        ...
        default="outputs/visgel-touch2img-tot/"
    )
    parser.add_argument(
        "--skip_grid",
        action='store_true',
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs/touch/eval_touch2img/visgel/visgel_touch2vision_concat_all_no_flip.yaml",
        help="path to config which constructs model",
    )
    parser.add_argument(
        "--ckpt",
        type=str,
        default="logs/2023-02-25T21-29-21_visgel_touch2vision_concat_all_no_flip/checkpoints/last.ckpt",
            ...
            with model.ema_scope():
                ...
                # for i, one_data in enumerate(data.datasets['test']):
                    ...
                    if not opt.skip_grid:
                        ...
                        # 把原图和gelsight放进去
                        origin_image = torch.cat((map_back(one_data[model.first_stage_key]), map_back(one_data[model.cond_stage_key][:,3:,:,:])), 0)
