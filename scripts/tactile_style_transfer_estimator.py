...
def main():
    ...
    gelslim_dir = "/home/ymdou/stable-diffusion/data/tactile_style_transfer/gelslims/gelslim_training_data_processed_flipped/gelslim_style_transfer_dataset_gelslim_pattern_01_2_lines_angle_1"

    touch_estimator.estimate(gelslim_dir)
